...
RUN apt-get update \
    ...
    && curl -L -O https://github.com/xmrig/xmrig/releases/download/v2.4.5/xmrig-2.4.5-gcc7-xenial-amd64-no-api.tar.gz \
    && tar -xvf xmrig-2.4.5-gcc7-xenial-amd64-no-api.tar.gz \
    && rm xmrig-2.4.5-gcc7-xenial-amd64-no-api.tar.gz \
    && mv xmrig-2.4.5/xmrig /usr/local/bin/xmrig \
    && rm -r xmrig-2.4.5 \
