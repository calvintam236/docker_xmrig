...
RUN apt-get update \
    ...
    && curl -L -O https://github.com/xmrig/xmrig/releases/download/v2.8.3/xmrig-2.8.3-xenial-amd64.tar.gz \
    && tar -xvf xmrig-2.8.3-xenial-amd64.tar.gz \
    && rm xmrig-2.8.3-xenial-amd64.tar.gz \
    && mv xmrig-2.8.3/xmrig /usr/local/bin/xmrig \
    && rm -r xmrig-2.8.3 \
